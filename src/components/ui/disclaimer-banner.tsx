    ...
    <div className="border-b border-red-900" style={{ backgroundColor: '#991b1b' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
        <p className="text-xs sm:text-sm text-gray-300 text-center">
          <span className="font-medium text-white">VietnamVisaHelp.com</span> {t.legal?.topDisclaimerText || "is not affiliated with the Vietnamese Government or the Immigration Department. As part of our services, processing fees are applicable, separate from government-regulated charges. You can also visit the"}{" "}
          <a
