...
export const COUNTRY_AIRPORTS: Record<string, AirportInfo[]> = {
  ...
  CN: [
    ...
    { code: "TFU", name: "Chengdu Tianfu", city: "Chengdu" },
    { code: "KMG", name: "Kunming Changshui", city: "Kunming" },
    { code: "XIY", name: "Xi'an Xianyang", city: "Xi'an" },
    { code: "HGH", name: "Hangzhou Xiaoshan", city: "Hangzhou" },
    { code: "NKG", name: "Nanjing Lukou", city: "Nanjing" },
    { code: "CKG", name: "Chongqing Jiangbei", city: "Chongqing" },
    { code: "XMN", name: "Xiamen Gaoqi", city: "Xiamen" },
    { code: "WUH", name: "Wuhan Tianhe", city: "Wuhan" },
    { code: "TSN", name: "Tianjin Binhai", city: "Tianjin" },
    { code: "TAO", name: "Qingdao Liuting", city: "Qingdao" },
    { code: "DLC", name: "Dalian Zhoushuizi", city: "Dalian" },
    { code: "SHE", name: "Shenyang Taoxian", city: "Shenyang" },
    { code: "HRB", name: "Harbin Taiping", city: "Harbin" },
    { code: "CSX", name: "Changsha Huanghua", city: "Changsha" },
    { code: "NNG", name: "Nanning Wuxu", city: "Nanning" },
    { code: "HAK", name: "Haikou Meilan", city: "Haikou" },
    { code: "SYX", name: "Sanya Phoenix", city: "Sanya" },
    { code: "FOC", name: "Fuzhou Changle", city: "Fuzhou" },
    { code: "CGO", name: "Zhengzhou Xinzheng", city: "Zhengzhou" },
    { code: "SJW", name: "Shijiazhuang Zhengding", city: "Shijiazhuang" },
    { code: "URC", name: "Urumqi Diwopu", city: "Urumqi" },
  ],
  HK: [
...
export const IATA_TO_ICAO: Record<string, string> = {
  ...
  PVG: "ZSPD", SHA: "ZSSS", PEK: "ZBAA", PKX: "ZBAD", CAN: "ZGGG", SZX: "ZGSZ",
  CTU: "ZUUU", TFU: "ZUTF", KMG: "ZPPP", XIY: "ZLXY", HGH: "ZSHC", NKG: "ZSNJ",
  CKG: "ZUCK", XMN: "ZSAM", WUH: "ZHHH", TSN: "ZBTJ", TAO: "ZSQD", DLC: "ZYTL",
  SHE: "ZYTX", HRB: "ZYHB", CSX: "ZGHA", NNG: "ZGNN", HAK: "ZJHK", SYX: "ZJSY",
  FOC: "ZSFZ", CGO: "ZHCC", SJW: "ZBSJ", URC: "ZWWW",
