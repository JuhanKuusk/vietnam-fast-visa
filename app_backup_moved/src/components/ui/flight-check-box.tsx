    ...
    <>
      ...
      {hasConnection && (
        <div className="mb-4 p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
          <div className="flex items-center gap-2 mb-2">
            <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-500 text-xs font-bold text-white">2</span>
            <span className="text-sm font-medium text-blue-800 dark:text-blue-300">Flight 2 - Arrival in Vietnam</span>
          </div>
          <input
            type="text"
          ...
          <p className="mt-2 text-xs text-blue-600 dark:text-blue-400">
            This flight arrives in Vietnam - used for your visa entry date
          </p>
      ...
      {flightNumber && flightNumber.length >= 3 && (
        <div className={hasConnection ? "opacity-60" : ""}>
          <FlightInfo
