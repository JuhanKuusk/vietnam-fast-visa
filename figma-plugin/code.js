...
function createPill(parent, text, x, y, bgColor, textColor) {
...
function createCTAButton(parent, text, x, y, width) {
...
// Create info card
function createInfoCard(parent, text, x, y, width, icon) {
...
function createStoriesAd(variant, index) {
...
function createFeedPortraitAd(variant, index) {
    const frame = figma.createFrame();
...
function createFeedSquareAd(variant, index) {
    const frame = figma.createFrame();
