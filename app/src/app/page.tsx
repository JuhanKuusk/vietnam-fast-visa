        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 w-full">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            >
              ...
              {t.banner.instantSupport}
            </button>
            {/* Ask thru WhatsApp Button */}
            <a
              href="https://wa.me/1234567890?text=Hi, I need urgent help with Vietnam visa!"
              target="_blank"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Direct Flights - January 16, 2026</h2>
                  <p className="text-blue-100 text-sm">From Denpasar Ngurah Rai International Airport to Vietnam</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-6">
              <div className="grid gap-3">
                {/* Flight Card - VJ 900 */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500 transition-colors">
                  <div className="flex items-center gap-4 mb-3 sm:mb-0">
                    <div className="w-12 h-12 bg-red-500 rounded-lg flex items-center justify-center flex-shrink-0">
                      <span className="text-white font-bold text-xs">VJ</span>
                    </div>
                    <div>
                      <div className="font-bold text-gray-900 dark:text-white">VJ 900</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">VietJet Air</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 sm:gap-8">
                    <div className="text-center">
                      <div className="text-lg font-bold text-gray-900 dark:text-white">13:10</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">DPS</div>
                    </div>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="text-center">
                      <div className="text-lg font-bold" style={{ color: '#c41e3a' }}>Hanoi</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">HAN</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500 transition-colors">
                  <div className="flex items-center gap-4 mb-3 sm:mb-0">
                    ...
                    <div>
                      <div className="font-bold text-gray-900 dark:text-white">VJ 894</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">VietJet Air</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 sm:gap-8">
                    <div className="text-center">
                      <div className="text-lg font-bold text-gray-900 dark:text-white">14:05</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">DPS</div>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-[2px] bg-gray-300 dark:bg-gray-600"></div>
                    ...
                    <div className="text-center">
                      <div className="text-lg font-bold" style={{ color: '#c41e3a' }}>Ho Chi Minh City</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">SGN</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500 transition-colors">
                  <div className="flex items-center gap-4 mb-3 sm:mb-0">
                    ...
                    <div>
                      <div className="font-bold text-gray-900 dark:text-white">VJ 898</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">VietJet Air</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 sm:gap-8">
                    <div className="text-center">
                      <div className="text-lg font-bold text-gray-900 dark:text-white">15:35</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">DPS</div>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-[2px] bg-gray-300 dark:bg-gray-600"></div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500 transition-colors">
                  <div className="flex items-center gap-4 mb-3 sm:mb-0">
                    <div className="w-12 h-12 bg-blue-900 rounded-lg flex items-center justify-center flex-shrink-0">
                      <span className="text-yellow-400 font-bold text-xs">VN</span>
                    </div>
                    <div>
                      <div className="font-bold text-gray-900 dark:text-white">VN 640</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">Vietnam Airlines</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 sm:gap-8">
                    <div className="text-center">
                      <div className="text-lg font-bold text-gray-900 dark:text-white">16:05</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">DPS</div>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-[2px] bg-gray-300 dark:bg-gray-600"></div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500 transition-colors">
                  <div className="flex items-center gap-4 mb-3 sm:mb-0">
                    ...
                    <div>
                      <div className="font-bold text-gray-900 dark:text-white">VJ 998</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">VietJet Air</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 sm:gap-8">
                    <div className="text-center">
                      <div className="text-lg font-bold text-gray-900 dark:text-white">17:25</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">DPS</div>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-[2px] bg-gray-300 dark:bg-gray-600"></div>
