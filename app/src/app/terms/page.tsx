      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-3">{t.legal?.youAgreeTo || "You agree to:"}</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-3">{t.legal?.youMayNot || "You may not:"}</p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-3">{t.legal?.notResponsibleFor || "We are not responsible for:"}</p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
